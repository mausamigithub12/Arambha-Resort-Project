    ...
    <section className="relative py-12 bg-gray-100">
      <div className=" px-4">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-4 pt-12 ">
            <span className="text-xs tracking-[0.3em] font-semibold  text-sky-600 ">ARAMBHA <span className="text-red-600 px-1">SPECIAL</span> </span>
          </div>
          ...
          >
          Discover what makes Arambha Resort a perfect choice for relaxation, celebrations and meaningful gatherings.
...
{/* <HashLink smooth to={specials.link}>
  <button className="w-full py-3 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition">
    Explore More
  </button>
</HashLink> */}
